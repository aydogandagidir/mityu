@echo off
REM Mityu Build Script for Windows
...
echo 🚀 Building Mityu application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Mityu Tauri application for Windows.
