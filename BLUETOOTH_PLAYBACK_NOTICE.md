...
When **reviewing recordings** in Mityu, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Mityu records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Mityu recordings** - Use wired/speakers instead
...
### This is Not a Mityu Bug

The issue is in **macOS's Bluetooth audio stack**, not in Mityu's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Mityu bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Mityu now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Mityu v0.4.0+ on macOS
