...
console.log(`GitHub Repository: aydogandagidir/mityu`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/aydogandagidir/mityu/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/aydogandagidir/mityu/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/aydogandagidir/mityu/releases/latest/download/latest.json`);
