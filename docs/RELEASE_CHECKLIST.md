...
**v1.1.0 validation scope (ADR-0038, extending ADR-0027 on the same terms):** A5 and C8 remain `DEFERRED / NOT PASSED` for v1.1.0 publication. Diarization ships labelled best-effort with no accuracy claim; its runtime (~a quarter of the recording), its lack of a progress indicator (H12) and its >1 GB peak at 90 minutes are recorded as accepted, disclosed risks. Everything below still applies.
